...
def Karatsuba_Toffoli_Depth_1(eng) :
    ...
    if (not resource_check):
        Round_constant_XOR(eng, a, 0xe7, n)
        Round_constant_XOR(eng, b, 0xee, n)
    ...
    #CNOT 161
    # 62 CNOT to combine
    # 23 CNOT to modular reduction

    if(not resource_check):
        print_state(eng, result, n)

    # 8 to 25, i.e. combine & modular 17 depth, 85 CNOT
    # combine & modular 27 depth, 70 CNOT
...
#def school_modular(eng, c): #8, 11, 12, 13
